...
1. `reference/ai-context.md`
2. `reference/work-management.md`
3. `reference/development-and-release.md`
4. `reference/testing-and-validation.md`
5. `reference/testing-profile.md`
6. Any additional references those documents identify for the active work
